...
<!-- similar-work start -->
<section
    class="similar-work services-work bg-dark_white pb-xs-80 pt-xs-80 pt-sm-100 pb-sm-100 pt-md-100 pb-md-100 pt-120 pb-120 overflow-hidden">
    <div class="container">
                ...
                <div class="similar-work__item mb-30 d-flex justify-content-between flex-column">
                    ...
                    <div class="bottom">
                        ...
                        <div
                            class="text pt-30 pr-30 pb-30 pl-30 pt-sm-20 pt-xs-15 pr-sm-20 pr-xs-15 pb-sm-20 pb-xs-15 pl-sm-20 pl-xs-15 font-la">
                            <p>
                                Es aquel diseñado para satisfacer las necesidades y requisitos de una organización
                                concreta. <br><br> <br>
                            </p>
                        </div>
                ...
                <div class="similar-work__item mb-30 d-flex justify-content-between flex-column">
                    ...
                    <div class="bottom">
                        ...
                        <div
                            class="text pt-30 pr-30 pb-30 pl-30 pt-sm-20 pt-xs-15 pr-sm-20 pr-xs-15 pb-sm-20 pb-xs-15 pl-sm-20 pl-xs-15 font-la">
                            <p>
                                Te permite obtener la renovación de un permiso, autorización o licencia, la cual fue
                                otorgada previa evaluación técnica y legal de la información y documentación presentada.
                            </p>
                        </div>
...
<div id="conta-info" class="container white-popup mfp-hide" style="background-color: #fff;">
    <div class="container" style="padding: 30px;">
        <div class="row">
            <h3>Contamos con experiencia en la contabilidad de:</h3>
            <div class="col-md-12 mt-5">
                <p>
                <ul>
                    <li>
                        * Doctores con Régimen de Actividad Empresarial y Profesional, Especialistas, Dentistas,
                        Psicólogos, Nutriólogos, fisioterapeutas etc.
                    </li>
                    <li>* Consultorios médicos privados.</li>
                    <li>* Torres de consultorios.</li>
                    <li>* Con sultoría privada.</li>
                    <li>* Médico Independiente.</li>
                </ul>
                </p>
            </div>
        </div>
