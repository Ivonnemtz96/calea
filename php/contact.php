...
function mandarError($codigo_de_error)
{
  ...
  if ($GLOBALS["tipo_de_procesamiento"] == 0) {
    ...
    if($codigo_de_error == "0"){
        header('location: /contacto?msj='. $codigo_de_error);
        exit;   
    }
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                  <tr>
                    <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Copyright © 2023 Calea Consultores. Todos los Derechos Reservados.</span>
